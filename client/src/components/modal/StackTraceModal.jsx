...
//   }
// }
const StackTraceModal = ({ open, onClose, userQuery, chatbotResponse, retrievedDocs, inputTokens, 
  outputTokens, queryTimestamp, performanceMetrics, model_name, sources }) => {
  return (
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              <Section title="User Query">
                ...
                <Typography variant="body2" color="text.secondary">
                  <strong>Timestamp:</strong> {queryTimestamp ? new Date(queryTimestamp).toLocaleString() : 'Invalid Date'}
                </Typography>
                <Typography variant="body2" color="text.secondary">
              ...
              <Section title="Query Performance Metrics">
                <Typography variant="body2" color="text.secondary" gutterBottom>
                  <strong>Total Processing Time:</strong> {performanceMetrics.totalTime} ms
                </Typography>
                <Divider sx={{ my: 1 }} />
                ...
                <Typography variant="body2" color="text.secondary">
                  • Response Generation Time: {performanceMetrics.generationTime} ms
                </Typography>
